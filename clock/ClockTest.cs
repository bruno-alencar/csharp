...
public class ClockTest
{
    ...
    [Fact]
    public void Can_not_add_negative_minutes()
    {
        var clock = new Clock(10).Add(-3);
        Assert.Equal("09:57", clock.ToString());
    }
    ...
    [Fact]
    public void Wraps_around_midnight_more_than_24h()
    {
        var clock = new Clock(23, 59).Add(1443*2);
        Assert.Equal("00:05", clock.ToString());
    }
    ...
    [Fact]
    public void Wraps_around_midnight_backwards_more_than_24h()
    {
        var clock = new Clock(0, 1).Subtract(1443*2);
        Assert.Equal("23:55", clock.ToString());
    }
    ...
    [Fact]
    public void Clocks_with_same_time_are_equal_using_operator()
    {
        var clock1 = new Clock(14, 30);
        var clock2 = new Clock(14, 30);
        Assert.True(clock2 == clock1);
    }
